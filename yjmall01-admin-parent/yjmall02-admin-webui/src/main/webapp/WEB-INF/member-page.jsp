        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="member/get/page.html" method="post" class="form-inline" role="form"
                          style="float:left;">
                            ...
                            <c:if test="${!empty requestScope.pageInfo.list }">
                                <c:forEach items="${requestScope.pageInfo.list }" var="member" varStatus="myStatus">
                                    <tr>
                                        ...
                                        <td>${member.email }</td>
                                        <td>
                                            <a href="member/to/edit/page.html?memberId=${member.id }&pageNum=${requestScope.pageInfo.pageNum}&keyword=${param.keyword}" class="btn btn-primary btn-xs">
