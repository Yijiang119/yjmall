...
<script type="text/javascript">
    ...
    function pageSelectCallback(pageIndex, jQuery) {
        ...
        // 执行页面跳转也就是实现“翻页”
        window.location.href = "project/get/page.html?pageNum=" + pageNum + "&keyword=${param.keyword}";
        // 取消当前超链接的默认行为
        return false;
    }
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="project/get/page.html" method="post" class="form-inline" role="form"
                          style="float:left;">
                            ...
                            <c:if test="${!empty requestScope.pageInfo.list }">
                                <c:forEach items="${requestScope.pageInfo.list }" var="project" varStatus="myStatus">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="project/to/agree/page.html?projectId=${project.id }&pageNum=${requestScope.pageInfo.pageNum}&keyword=${param.keyword}" class="btn btn-primary btn-xs">
