package com.yijiang.mall.filter;

import com.netflix.zuul.ZuulFilter;
import com.netflix.zuul.context.RequestContext;
import com.netflix.zuul.exception.ZuulException;
import com.yijiang.mall.constant.AccessPassResources;
...
public class MallAccessFilter extends ZuulFilter {
    ...
    public Object run() throws ZuulException {
        ...
        Object loginMember = session.getAttribute(MallConstant.ATTR_NAME_LOGIN_MEMBER);
        // 4.判断 loginMember 是否为空
        if (loginMember == null) {
            // 5.从 requestContext 对象中获取 Response 对象
            HttpServletResponse response = requestContext.getResponse();
            // 6.将提示消息存入 Session 域
            session.setAttribute(MallConstant.ATTR_NAME_MESSAGE,
                    MallConstant.MESSAGE_ACCESS_FORBIDEN);
