...
import com.yijiang.mall.entity.po.MemberConfirmInfoPO;
import com.yijiang.mall.entity.po.MemberLaunchInfoPO;
import com.yijiang.mall.entity.po.ProjectPO;
import com.yijiang.mall.entity.po.ReturnPO;
import com.yijiang.mall.entity.vo.*;
import com.yijiang.mall.mapper.*;
    ...
    public DetailProjectVO getDetailProjectVO(Integer projectId) {
        ...
        switch (status) {
            case 0:
                ...
                break;
            case 1:
                detailProjectVO.setStatusText("换购中");
                break;
            case 2:
                detailProjectVO.setStatusText("换购成功");
                break;
            case 3:
                detailProjectVO.setStatusText("换购失败");
                break;
            default:
                break;
        }
        ...
        try {
            ...
            int lastDay = detailProjectVO.getLastDay() - passDay;
